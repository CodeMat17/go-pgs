...
export default function Footer() {
  return (
    <footer className='bg-gray-900 text-white border-t'>
      <div className='container px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-2 lg:grid-cols-4 gap-8'>
        {/* University Info */}
        <motion.div
          ...
          <h3 className='text-xl font-semibold mb-4'>GO Postgraduate School</h3>
